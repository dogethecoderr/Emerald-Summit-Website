        ...
        child: Row(
          children: [
            CircleAvatar(
              ...
              child: Text(
                appState.userName.split(' ').map((w) => w[0]).take(2).join(),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(appState.userName, style: theme.textTheme.titleLarge),
        ...
        child: Column(
          children: [
            ...
            SwitchListTile(
              ...
              subtitle: const Text('Next-session reminders & announcements'),
            ...
            OutlinedButton.icon(
              onPressed: () {
                ScaffoldMessenger.of(context)
                  ...
                  ..showSnackBar(
                    const SnackBar(
                      content: Text('Generating your signed certificate…'),
                    ),
                  );
              },
